...
<!ENTITY jbrownfp SYSTEM "jbrownfp.jpg" NDATA jpeg>
<!ENTITY jbrowntp SYSTEM "jbrowntp.jpg" NDATA jpeg>
<!ENTITY jbrownvs SYSTEM "jbrownvs.jpg" NDATA jpeg>
]>
<TEI.2>
  <teiHeader type="North Carolina" status="new">
    <fileDesc>
      <titleStmt>
        <title><emph>Slave Life in Georgia: A Narrative of the Life, Sufferings, and Escape of John Brown, a Fugitive Slave, Now in England:</emph>
Electronic Edition.</title>
        <author>Brown, John, fl. 1854 </author>
        <editor role="editor">Chamerovzow, Louis Alexis, ed. </editor>
 ...
 supported the electronic publication of this title.</funder>
        ...
        <respStmt>
          ...
          <name id="ns">Apex Data Services, Inc., LeeAnn Morawski  and Natalia Smith</name>
        </respStmt>
      </titleStmt>
      <editionStmt>
        <edition>First edition, <date>2001</date></edition>
      </editionStmt>
      <extent>ca.     330K</extent>
      <publicationStmt>
        <publisher>Academic Affairs Library, UNC-CH</publisher>
        <pubPlace>University of North Carolina at Chapel Hill, </pubPlace>
        <date>2001.</date>
        <availability status="unknown">
          <p><a href="http://rightsstatements.org/vocab/CNE/1.0/">Copyright Not Evaluated.</a> The copyright and related rights status of this Item has not been evaluated. Please refer to the organization that has made the Item available for more information. You are free to use this Item in any way that is permitted by the copyright and related rights legislation that applies to your use.</p>
</availability>
      </publicationStmt>
      <sourceDesc>
        <biblFull>
          <titleStmt>
            <title type="title page"> Slave Life in Georgia: A Narrative of the Life, Sufferings, and Escape of John Brown, A Fugitive Slave, Now In England</title>
            <editor role="editor">Edited by L. A. Chamerovzow</editor>
          </titleStmt>
          <extent>i-ii,  250  p., ill.</extent>
          <publicationStmt>
            <pubPlace>LONDON:</pubPlace>
            <publisher>MAY BE HAD ON APPLICATION TO THE EDITOR, AT No. 27, NEW BROAD STREET, AND OF ALL BOOKSELLERS.</publisher>
            <date>1855.</date>
            <authority/>
          </publicationStmt>
          <notesStmt>
            <note anchored="yes">Call number   E444.B87  (Robert W. Woodruff Library, 
Atlanta University Center)</note>
          </notesStmt>
        </biblFull>
      </sourceDesc>
    </fileDesc>
    ...
    <profileDesc>
      ...
      <textClass>
        <keywords scheme="lcsh">
          <list type="simple">
            <item>African Americans -- Georgia -- Biography.</item>
            <item>Brown, John, fl. 1854.</item>
            <item>Fugitive slaves -- Georgia -- Biography.</item>
            <item>Plantation life -- Georgia -- History -- 19th century.</item>
            <item>Plantation life -- Southern States -- History -- 19th century.</item>
            <item>Slavery -- Georgia -- History -- 19th century.</item>
            <item>Slaves -- Georgia -- Biography.</item>
            <item>Underground railroad.</item>
          </list>
        </keywords>
      </textClass>
    </profileDesc>
  ...
  <text>
    <front>
      <div1 type="frontispiece">
        <p>
          <figure id="frontis" entity="jbrownfp">
            <p>From a Colodion by J. Dudman.<lb/>[Frontispiece Image]</p>
          </figure>
        </p>
      </div1>
      <div1 type="title page">
        <p>
          <figure id="title" entity="jbrowntp">
      ...
      <div1 type="title page verso">
        <p>
          <figure id="verso" entity="jbrownvs">
      ...
      <titlePage>
        <docTitle>
          <titlePart type="main">SLAVE LIFE IN GEORGIA: 
<lb/>A NARRATIVE 
<lb/>OF THE 
<lb/>LIFE, SUFFERINGS, AND ESCAPE 
<lb/>OF 
<lb/>JOHN BROWN,  <lb/><hi rend="italics">A Fugitive Slave,</hi><lb/>NOW IN ENGLAND.</titlePart>
        </docTitle>
        <byline>EDITED BY <lb/> L. A. CHAMEROVZOW, <lb/> SECRETARY OF THE BRITISH AND FOREIGN ANTI-SLAVERY SOCIETY.</byline>
        <docImprint><pubPlace>LONDON:</pubPlace>
<publisher>MAY BE HAD ON APPLICATION TO THE EDITOR, <lb/> AT No. 27, NEW BROAD STREET, <lb/> AND OF ALL BOOKSELLERS.</publisher>
<docDate>1855.</docDate></docImprint>
        <pb id="pxxx2" n="verso"/>
        <docImprint>
          <publisher>W. M. Watts, Crown Court, Temple Bar.</publisher>
        </docImprint>
      </titlePage>
      <div1 type="preface">
        <pb id="pi" n="i"/>
        <head>PREFACE.</head>
        <p>The Editor is conscious that the following Narrative has only its truthfulness to recommend it to favourable consideration. It is nothing more than it purports to be, namely; a plain, unvarnished tale of real Slave-life, conveyed as nearly as possible in the language of the subject of it, and written under his dictation. It would have been easy to fill up the outline of the picture here and there, with dark shadows, and to impart a heightened dramatic colouring to some of the incidents; but he preferred allowing the narrator to speak for himself, and the various events recorded to tell their own tale. He believes few persons will peruse it unmoved; or arise from a perusal of it without feeling an increased <sic corr="abhorrence">abborrence</sic> of the inhuman system under which, at this
<pb id="pii" n="ii"/>
hour, in the United States of America alone, three millions and a half of men, women, and children, are held as “chattels personal,” by thirty-seven thousand and fifty-five individuals, many of them professing Ministers of the Gospel, and defenders of “the peculiar institution.”</p>
        ...
        <closer>
          <dateline>27, New Broad Street,
<lb/>London, January, 1855.</dateline>
        </closer>
      </div1>
    </front>
    <body>
...
<pb id="p3" n="3"/>
with the exception of another plank on which we laid straw or cotton-pickings, and over that a blanket.</p>
        <p>Our mistress Betty Moore was an old, big woman, about seventy, who wore spectacles and took snuff. I remember her very well, for she used to call us children up to the big house every morning, and give us a dose of garlic and rue to keep us “wholesome,” as she said, and make us “grow likely for market.” After swallowing our dose, she would make us run round a great sycamore tree in the yard, and if we did not run fast enough to please her, she used to make us nimbler by laying about us with a cow-hide. She always carried this instrument dangling at her side, like ladies in this country wear their scissors. It was painted blue, and we used to call it the “blue lizard.” She used to like to see her people constantly employed, and would make us all set to work at night, after our day's labour was over, picking the seed out of cotton. We had a hard time of it with the old lady.</p>
        <p>At this period, my principal occupation was to nurse my little brother whilst my mother worked in the field. Almost all slave children have to do the nursing; the big taking care of the small,
<pb id="p4" n="4"/>
who often come poorly off in consequence. I know this was my little brother's case. I used to lay him in the shade, under a tree, sometimes, and go to play, or curl myself up under a hedge, and take a sleep. He would wake me by his screaming, when I would find him covered with ants, or <sic corr="mosquitoes,">musquitos,</sic> or blistered from the heat of the sun, which having moved round whilst I was asleep, would throw the shadow of the branches in another direction, leaving the poor child quite exposed.</p>
        <p>The children of both sexes usually run about quite naked, until they are from ten to twelve years of age. I have seen them as old as twelve, going about in this state, or with only an old shirt, which they would put on when they had to go anywhere very particular for their mistress, or up to the great house.</p>
        <p>The clothing of the men consists of a pair of thin cotton pantaloons, and a shirt of the same material, two of each being allowed them every year. The women wear a shirt similar to the men's, and a cotton petticoat, which is kept on by means of braces passing over their shoulders. But when they are in the field, the shirt is thrown aside. They also have two suits allowed them
<pb id="p5" n="5"/>
every year. These, however, are not enough. They are made of the lowest quality of material, and get torn in the bush, so that the garments soon become useless, even for purposes of the barest decency. We slaves feel that this is not right, and we grow up with very little sense of shame; but immorality amongst ourselves is not common, for all that.</p>
        <p>Betty Moore had three daughters. The eldest was married to one Burrell Williams, who acted as Betty's overseer. The second was the wife of one James Davis; and the third was unmarried, when I first began to notice the persons about us. At last the third got married to one Billy Bell, and then I experienced my first serious tribulation.</p>
...
especially after a particular time, when a mare in the team I used to drive died. She got overheated in the field, and would not eat her corn when I put her up at noon. I noticed it when I took her out again, in about an hour after, not knowing she was not fit to work. She dropped down and died in the plough. I was sent to tell my master to come and see the mare, and on my way, stopped in the stable, and shifted the uneaten corn out of the mare's bin into another, substituting the cobs that the other horse had left. I did this lest Stevens should go into the stable and see that the mare had not eaten her corn, and he should flog me for taking her out under those circumstances. The artifice succeeded so far, that he attributed the mare's death to her being overheated in the sun; but this did not save me from a very severe flogging.</p>
        <p>From this time he led me a dreadful life, and became so savage to me, I used to dread to see him coming. I had only too good reason for my fears.</p>
        <p>I was ploughing one day, some long time after the mare died, with what we call a buzzard plough. It is made so as to cut under the roots of the grass and weeds that choke the cotton, and must be
<pb id="p29" n="29"/>
...
<pb id="p33" n="33"/>
married, the young woman's relatives taking her view of matters, and coinciding in the opinion that it was wise in her to marry the man she loved, whose sterling qualities she had learned to appreciate.</p>
...
time the captain had reckoned upon, owing to delays in the procuring of the cargo. Slave-labour was dear, and the captain had to pay high wages to the slave who had been hired to him to do John Glasgow's work, while John lay pining in gaol, desiring nothing so much as that he might be doing it himself. The captain was displeased at being thus imposed upon, especially when he thought of the wages he would have to pay to John Glasgow; and matters in his mind were not improved when, the time having come for the ship to sail, he found that the gaol-fees for John's release had run up enormously high, and with what he had already paid and would have to pay, made so considerable a sum, that, looking at the whole matter commercially, to hand over so much money was wholly out of the question: and considering it humanely, was out of the question too. Besides he was “only a nigger after all;” so the captain refused to pay the gaol-fees: he set sail without John, leaving him, as yet, in ignorance of his dreadful fate.</p>
        <p>Poor John's wife and children! They were already expecting him home, on the day he was taken out of the gaol and sold on the auction-block for three hundred and fifty dollars, to
<pb id="p37" n="37"/>
...
<pb id="p42" n="42"/>
bent knee, and using it as a handle, gives the unfortunate a twirl, and sends him spinning round on the hard point of the stake, which perforates the heel or the sole of the foot, as the case may be, quite to the bone.</p>
...
<pb id="p74" n="74"/>
happening to me, when all of a sudden I heard a man chopping wood. I soon came up to him. He was a white man, and he asked me where I was going.</p>
        <p>“Into Ohio,” said I.</p>
        <p>“Are you free?” he asked.</p>
        <p>“Yes, Sir,” I answered.</p>
        <p>“Where's your pass, Sir?” he said.</p>
        <p>I took out the pass I had spoken of, and handed it to him. He saw at once that it was forged, and told me so. I drew out of him that a genuine pass was always signed by a great many individuals, and countersigned by the clerk of the district court, besides bearing the seal. He added, in answer to questions from me, that I was in Tennessee, and that no pass signed by one person would be of any use to enable me to go out of one State into another. I felt that I was caught, and hardly knew what to do. The man spoke very loud and strong at first, but I suppose there was something in my manner that made him feel timid, for he presently began to talk more softly, trying to calm me down. At last he said, if I would go home with him, he would see no harm came to me, and he would provide me with proper passes to take me through Tennessee, Kentucky,
<pb id="p75" n="75"/>
...
<pb id="p93" n="93"/>
also used to go to New Echota, in the Cherokee purchase, on the Ooestennala river. A very large body of Indians, gathered from this territory, had been located there sometime between 1836 and 1838, where they remained six months, under guard, being on their way to their new location in Arkansas. There were some thousands in all, under the chiefs John Ross and John Ridge. Stevens used to send us to these people to sell them provisions, generally causing his son-in-law, Joe Stokes, to accompany us. So it was I came to know there was a good road open for me thus far.</p>
        <p>As soon as it was dark enough to make it safe, I set out once more on my travels, with a full determination either to gain my freedom, or to die in the attempt.</p>
        <p>The incidents of my journey, during the first eight or ten days, were not of sufficient note to need my dwelling particularly upon them. My plan was to walk all night, and to hide myself in the day. I used to listen with painful attention for the sounds of footsteps, and when I heard, or fancied I heard a noise, I would conceal myself behind a log, or in a tree, or anywhere else, until the party had gone by, or my fears were allayed.
<pb id="p94" n="94"/>
I kept myself from starving by grubbing up sweet potatoes out of the fields by the way-side, which I cooked in a fire I made with dry sticks. When I came to such a field, I would get as many potatoes as I could conveniently carry for store; but as they were heavy and cumbersome, it may be supposed the stock I obtained on such occasions was not very large. In this way I travelled on out of Georgia into Alabama, until I reached a place, which I afterwards learned is called Tuscumbia, on the Tennessee river. I remember this place very well, for close to Tuscumbia there is a bubbling spring, and the landing-place is about two miles lower down.</p>
        <p>When I got here, I became afraid to continue travelling by land. I considered what I should do; and concluding at last that the river must run into the sea, and that if I once got to the seaside, I should be sure to find some Englishmen there who would tell me the way to England, I determined to construct a raft, and float myself down upon it.</p>
        <p>The reader will bear in mind that at this time I did not know where England was, but, foolishly enough, believed it was not very far off. Had I known where the Tennessee river would have
<pb id="p95" n="95"/>
floated me to, I should probably have turned off in some other direction. But I now look upon my ignorance of the fact, at that time, as a happy circumstance, to which I am, in all probability, indebted for my liberty.</p>
        <p>I now sought out a place of concealment, which I soon discovered, in the wood, not far from the landing-place, and here I watched for float-wood as it came down the river. I procured three sticks of this timber, each being about fifteen feet long, and perhaps a foot and a half in diameter. These I dragged into shallow water, and bound firmly together with the blue grapevine, which grew in abundance in the wood; and having completed the raft, which was about five feet wide, I made it fast under the bushes that grew quite close down to the river-side, hanging quite over the water.</p>
        <p>Prowling about at night, I had paid a visit to an old warehouse or shed that had been abandoned at the landing-place, it being now the fall-season, and the water in the river low. Here I found an old wedge-axe, and a piece of sheet-iron, that I afterwards conjectured had been part of the funnel of a steam-vessel; for, I need scarcely observe, I had not, at this time, ever seen a
<pb id="p96" n="96"/>
steamer. The iron was a good find for me, for I at once perceived that it would serve me to kindle a fire upon; so I took it into the wood, and hammered it out flat on a log; and very useful I found it. I afterwards rummaged up a board, which I fashioned into a paddle with my jack-knife, and having picked out a pole of timber, to help me further in navigating my raft, my preparations for starting were complete.</p>
        <p>I pushed off that evening, as soon as it became dark enough to allow of my doing so safely. I had put some sand on the iron plate, and made preparations to kindle a fire on it, so that any one by chance noticing me going down the river, might take me for a fisherman. The next morning I beached my raft at a convenient spot, and having jumped ashore, pulled it up under the bushes and brush, so as effectually to conceal it. I then laid down and slept, and after I had rested, sauntered about until nightfall, when I put off again.</p>
        <p>I was about nine days going down the river in this manner. During that time I saw several people, but do not think they caught sight of me, because I was so very cautious not to shew myself. I travelled always by night, concealing myself by day. I usually selected a place to
<pb id="p97" n="97"/>
land, in the neighbourhood of dwellings, as I was almost certain to find <sic corr="potato-fields">potatoe-fields</sic> near them. To these I paid as frequent visits as I could, prudently, bringing away with me as many potatoes as would last me for a couple or three days, and which I stored away on my raft. These, roasted, were my only food during the nine days, with one exception. One night my raft ran foul of a line stretched across the water. I traced it with my paddle and pole, and found it had a good many other smaller lines attached to it, each having a hook at the end. On one of them was a cat-fish, which I appropriated, and off which I made a famous feast.</p>
        <p>At the end of about nine days I found the water becoming too deep for my pole, and the river widening considerably. Still I contrived to keep on, by using my paddle industriously, and not going far from the banks, until one evening, and whilst I was wondering where the great water, opening beyond, would take me to, I heard all of a sudden a great roaring and splashing. Almost directly after I saw two big, red eyes coming down full upon me, raised, as it appeared, only just above the level of the water. I also saw showers of sparks shooting up in the air,
<pb id="p98" n="98"/>
mingling with red fiery smoke—all, as I thought, being belched up by this strange monster, as he came along, hissing and heaving, and splashing up the water. I fell into a horrible fear, for I verily believed it to be Old Sam,<ref id="ref1" n="1" rend="sc" target="note1" targOrder="U">*</ref><note id="note1" n="1" rend="sc" place="foot" anchored="yes" target="ref1"><p>* The negroes so call the devil—ED.</p></note> and that he had waylaid and was going to catch me. With all the trouble in the world I reached the bank, and leaped ashore, and abandoning my raft, took to my heels, and ran on towards some lights I had noticed; which I afterwards found were those of a town called Paducah, about a mile from where I had landed, in my terror.</p>
        <p>I had reached the Ohio river.</p>
        <p>I need not inform my readers that the monster I took to be the devil was only a steam-boat. It seems to me now very foolish that I should have been so frightened; but if they had been placed in the same circumstances, and been as ignorant as I was, they would have felt quite as much alarmed, I am sure.</p>
      </div1>
      <div1 type="chapter">
        <pb id="p99" n="99"/>
        <head>CHAPTER XI. <lb/> FORTUNE AND MISFORTUNE.</head>
        <p>WHEN I look back upon the events of my life, I fancy I can perceive the directing hand of Providence in all that <sic corr="befell">befel</sic> me at this particular time. My very ignorance may have proved one means of my safety, for if I had not been terrified into abandoning my raft, I do not see how I could have escaped again speedily falling into the hands of my enemies. The circumstances of my escape show me now, that every thing worked together for my ultimate good, though I did not, at the time, think so, nor easily reconcile myself to the various misfortunes which <sic corr="befell">befel</sic> me, and delayed my obtaining my freedom.</p>
        <p>Had it been broad day instead of quite dark, when I left my raft to be carried away by the current, my appearance in Paducah would certainly had led to my re-capture. I was dirty and miserable-looking from fatigue, travelling, and want of sufficient food, and my clothes were all worn and ragged. I got into the town, however,
<pb id="p100" n="100"/>
at an hour when few people were about, and it was easier for me to avoid them. After resting to take breath, I determined to look out for a barber's shop. In the United States, the barbers are generally coloured men, and I concluded I should be in safer hands with one of my own race. So I strolled about, up and down the streets, peeping in at doors and windows, until at length I found what I was seeking. After a moment's hesitation I knocked gently at the door. It was presently opened by a black man, who no sooner saw me, than he understood by my looks that I wanted assistance. He at once invited me in, and immediately closed and fastened the door.</p>
        <p>Having made me take a seat he asked me which way I was going.</p>
        <p>“My master's gone down to New Orleans,” I said, “and I want to join him again.”</p>
        <p>I knew he did not believe me, and that he saw I was telling him a lie; but I felt afraid to tell him the truth right out.</p>
        <p>“You're a runaway,” he answered, almost directly. “Where have you come from?”</p>
        <p>I did not hesitate now to confess the fact; and as I thought he looked friendly, I told him my story from beginning to end, in as few words as
<pb id="p101" n="101"/>
I could, he listening attentively all the while. When I had finished, he said:</p>
        <p>“You must n't stop here: it would be dangerous for both of us. You can sleep here to-night, however, and I will try to get you away in the morning. But if you were seen, and it were found out I was helping you off, it would break me up.”</p>
        <p>Concluding I was hungry, he gave me some fried fish and some hoe-cake for supper. I need not say I ate heartily. We chatted for an hour or so, and I learnt his name, and that he was a free man from Illinois. I must not repeat his name, but if ever this book reaches him, he will remember me, and I wish him to know that I have always thought of him with gratitude for his kindness to me that night, and for his fidelity to me in my sore trouble.</p>
        <p>He put me to sleep on his sofa, but I could not close my eyes for fear, as well as for a kind of shivering, brought on by my long exposure to cold and wet. If I slept at all, it was only by snatches, so that I felt quite relieved when morning came. My benefactor then informed me he had been making inquiries, and there was a steamer ready to start for New Orleans, on board of which I must go. She was called the <hi rend="italics">Neptune.</hi>
<pb id="p102" n="102"/>
I did not desire any thing better than to be off, fancying still that if I got safely to New Orleans I should find no difficulty in reaching England. Accordingly I jumped up, and after a hurried breakfast, made the best of my way to the quay, where I soon saw the steamer.</p>
        <p>I went straight on board, and saw the Captain, to whom I repeated the story of my master's having gone on to New Orleans; that I had missed him, and wanted to join him as soon as possible. He did not say much then, being very busy, and I went and stood aside, trying to avoid notice. After we started, he began walking about, contriving to draw near to me every now and then, when he would fix his eyes on me in a very doubting way. At length we got to the fork of the Mississippi, below Paducah and Cairo, where the Ohio joins it. Here there is, in the last-named river, a flat shallow, and here the steamer took ground, knocking off her two iron-chimneys, and receiving other damage. The confusion and bustle caused by this accident diverted the Captain's attention from me, for a time, and were quite a relief to me from his constant watching. After a while we got free again, and he recommenced walking the deck, as before. He
<pb id="p103" n="103"/>
...
pounds a day. My good picking, however, made it worse for me, for, being an old picker, I did well at first; but the others, being new at the work, were flogged till they fetched up with me; by which time I had done my best, and then got flogged for not doing better.</p>
        ...
        <p>First a stock is chosen of a convenient length, the butt of which is loaded with lead, to give the whip force. The stock is then cleverly split to within a foot or so of the butt, into twelve strips.
<pb id="p130" n="130"/>
A piece of tanned leather, divided into eight strips, is then drawn on the stock, so that the split lengths of the wooden stock and the strips of leather can be plaited together. This is done very regularly, until the leather tapers down to quite a fine point, the whip being altogether about six feet long, and as limber and <sic corr="lithesome">lithsome</sic> as a snake. The thong does not bruise, but cuts; and those who are expert in the use of it, can do so with such dexterity, as to only just raise the skin and draw blood, or cut clean through to the bone. I have seen a board, a quarter of an inch thick, cut through with it, at one blow. I have also seen a man fasten a bullet to the end of the thong, and after giving the whip a whirl round his head, send the thong whizzing forward, and drive the bullet into a door. This fearful instrument is called a “bull-whip,” because it is the master of all whips. It is also employed to “whip down” savage bulls, or unruly cattle. I have seen many a horse cut with it right through the hollow of the flank, and the animal brought quivering to the ground. The way of using it is to whirl it round the head until the thong acquires a certain forward power, and then to let the end of the thong fall across the
<pb id="p131" n="131"/>
back, or on the part intended to be cut, the arm being drawn back with a kind of sweep. But although it is so formidable an instrument, it is seldom employed on slaves in such a manner as to disable them, for the “licks” are always regulated to an extreme nicety, so as only to cut the flesh and draw blood. But this is quite bad enough, and my readers will readily comprehend that with the fear of this punishment ever before us at Jepsey James', it was no wonder we did our utmost to make up our daily weight of cotton in the hamper.</p>
        <p>After our day's picking was done, we got for supper the same quantity of “mush” as we had for breakfast in the morning, and this was the only kind of food we had during the whole time I was with Jepsey James, except what we could steal.</p>
        <p>We went on picking cotton for two weeks, by the end of which time the season was at an end. We then were set to packing, and I was put in the jin-house.</p>
        <p>I suppose I had the misfortune to get a run of bad masters. Jepsey was as bad as any of my former ones, and things were done at his place which makes my blood curdle to speak of. For
<pb id="p132" n="132"/>
instance, he would flog women when they were in a certain delicate condition, previously causing a hole to be dug in the ground for them to lie in more conveniently, so as not to injure the burden they were carrying. I have myself witnessed this, and even been forced to hold them down. The poor women were dreadfully hard worked. I have known them to be taken in travail when in the field, and immediately after their trouble was over, compelled to return to work. One of these women I well remember. She was as white as Ellen Craft: that is, she might have passed for a white person without much fear of detection. There were, however, it seems, but very few births on Jepsey James' plantation, the female slaves being over-driven and over-worked.</p>
        <p>Several instances of cruelty occurred whilst I was there, of which I will relate one or two.</p>
        <p>Thomas James, Jep's second son, had cast his eyes on a handsome young negro girl, to whom he made dishonest overtures. She would not submit to him, and finding he could not overcome her, he swore he would be revenged. One night he called her out of the jin-house, and then bade me and two or three more, strip her naked; which we did. He then made us throw her
<pb id="p133" n="133"/>
down on her face, in front of the door, and hold her whilst he flogged her—the brute—with the bull-whip, cutting great gashes of flesh out of her person, at every blow, from five to six inches long. The poor unfortunate girl screamed most awfully all the time, and writhed under our strong arms, rendering it necessary for us to use our united strength to hold her down. He flogged her for half an hour, until he nearly killed her, and then left her, to crawl away to her cabin.</p>
        <p>Poor girl! How my heart  bled for her!</p>
        <p>Another time John James, another of Jep's sons, and a married man, sought the wife of a slave named Abram. In order to gain access more easily to the man's cabin, he set a tree on fire, and then sent Abram to watch the fence, lest it should catch and burn down. Abram suspected John James' design upon his wife, and that this was a mere pretext to get rid of him for a while. His cabin was a full mile from the spot he had to watch, but he felt so uneasy about home, that instead of stopping at the fire, he ran to and from the fence to his hut. The consequence was that the fence—which was of solid wood—took fire, and burnt for the distance of three quarters of a mile. I mention this circumstance,
<pb id="p134" n="134"/>
because it happened on a certain Saturday night, when I had made preparations to run off on the Sunday, and I was compelled instead, to set to splitting timber to make the fence good. By “preparations,” I mean that I had been looking out for chances, and made up a plan in my mind for taking a fresh start.</p>
        <p>Jepsey James had all along inspired me with dread, and my old determination to get away from slavery had been quickened by sundry conversations I overhead on several occasions, all having reference to me.</p>
        <p>One day master came in with a “nigger hunter” and his six dogs. He wished to frighten me: at least I concluded so. I had been sullen for some days, and he had observed it. On this occasion, he addressed one of the hands named Amos:</p>
        <p>“Amos,” he said, “when are any of you niggers going to run off again?”</p>
        <p>“We does n't want to run away, Sir,” Amos answered.</p>
        <p>“Oh yes you do,” said master. “You'd better run off, some of you. We've got some of the right kind of dogs now to fetch you back, quicker a heap than you can run a-head. You'd
<pb id="p135" n="135"/>
better start, some of you. In less than two days we'll bring you back.”</p>
        <p>He looked at me very hard and suspiciously whilst he spoke: so, said I to myself:</p>
        <q direct="unspecified">
          <p>“Old fellow, you're speaking at me, I know. But I'll give you and your dogs a chance to track me yet, any how.”</p>
        </q>
        <p>On another occasion I overheard him speaking to his son John, with whom, by the way, I was a bit of a favourite. He said I looked hard, as though I should give him some trouble to break me in. He added that I must be flogged, to see how I should stand it, and that it would have to be done before the summer came on, or the bushes sprouted into leaf, as, if I were flogged then, and should run off, it would be more difficult to find me out.</p>
        <p>These conversations did not hold out a very encouraging prospect for me, and I therefore determined to be off as soon as I could. I arranged my plan in my head, which was to keep up the Mississippi, and make for the North as rapidly as possible. I only now waited for the favourable moment to start.</p>
        <p>I have stated what circumstance prevented me from setting off on the day I had fixed upon for
<pb id="p136" n="136"/>
making the attempt. On the Monday night, however, having now been at Jepsey James' three months, I started on my travels once more. I watched until the negro quarters had been inspected, then skulked out into the yard, where I had observed a small skiff. I dragged it down to the water, and crossed over to the Arkansas side, the river here being about a mile in width. Having reached the bank, I turned the skiff adrift. I had chosen this mode of making my escape, because I knew the skiff would be missed, and that James would naturally conclude I had gone towards New Orleans, and would hunt for me in that direction, never suspecting I should go up stream. I think I was right in this conjecture. Any how, here I was safe for the present, and I at once set off walking as hard as I could put foot to the ground.</p>
      </div1>
      <div1 type="chapter">
        <pb id="p137" n="137"/>
        <head>CHAPTER XV. <lb/> HOW I CAME TO BE JOHN BROWN.</head>
        <p>DURING my journey I observed the plan I had followed on former occasions; namely, walking by night, and lying by for rest and concealment in the day, sleeping behind logs, like a wild man. I guided my course by following the muddy waters of the Mississippi, but I was frequently baulked by coming to inlets or <hi rend="italics">bayous.</hi> These are considerably lower than the bed of the river, and are full of alligators. I used to hear these creatures at night, snorting and <sic corr="splashing">plashing</sic> about in the water—to my mortal terror—for I did not know but that I might, at any moment, unexpectedly fall into their hungry jaws. When I came to one of these <hi rend="italics">bayous</hi> I would follow the bank until I came to a ferry. Here I would stop, and watching an opportunity, draw the staple that kept the boat fastened, and cross over in the boat to the opposite side, where I would leave it. I would then go down that bank until I reached the Mississippi again. I lived, or rather sustained
<pb id="p138" n="138"/>
life, by eating raw corn, potatoes, pine roots, and sassafras buds. The country I passed through appeared to be quite thinly inhabited; there was, however, plenty of wood and reed cane, so that I found no sort of difficulty in hiding myself, even quite close down to the water's edge. From these places of concealment I used to watch the steamers going up and down the river; and these served to guide me in my course, for I knew they must start from somewhere, and I hoped that I might find friends there, and rest for a time.</p>
        <p>At last I reached a great town where the steamers were in large numbers. I cannot say, with any accuracy, how long I was getting to it many weary days and nights I know. I judge it must have taken me at least three months. Being at a loss what to do, or where to go, without information, I took courage, and went on board one of the steamers. It was early in the morning, and there were not very many people about, on deck; but my appearance excited the suspicion of the captain, who pointed me out to the mate, and said I looked like a runaway. I observed them closely without appearing to do so, and went to the cook, who was a coloured man, to beg
<pb id="p139" n="139"/>
something to eat. He gave me some bread and beef. I also learnt that the name of the steamer was the <hi rend="italics">Ellen Kirkman,</hi> and that the great town was St. Louis, in Missouri. The cook asked me a great many questions, but I did not like to answer him too freely; especially as I was watched by the captain and the mate, who had now both placed themselves at the bow of the boat, evidently with the intention of capturing me, as they concluded I must pass them to get ashore. The <hi rend="italics">Ellen Kirkman</hi> was one of the outside vessels. I had made my way to her, because I thought there would be less chance of my being noticed by the along shore people. Seeing how closely I was watched, and feeling quite satisfied that the captain and the mate intended me a mischief, I made up my mind how to circumvent them; and watching a favourable moment, suddenly slipped off on the opposite side of the vessel, at the stern, and crossed the other steamers till I reached the shore. As soon as I felt land again, I walked off at a tolerably rapid pace down the quay, and turned sharp round into the first street.</p>
        <p>It was Sunday morning, and the people were going to meeting. I noticed a number of coloured people walking all in one direction, towards a
<pb id="p140" n="140"/>
chapel, where some more were going in: for the State I was now in, bordering on a Free State, they were permitted the right—denied to them in other Slave States—to worship God like other folks. To avoid suspicion, I went in too and sat down, and waited till the meeting was over, and all the congregation gone, with the exception of the deacons and other principal men belonging to it. I followed them out, and after we had gone on a little way they closed up and began talking to me. They soon discovered me to be a stranger, and one of them then invited me to go home with him. I gladly accepted his offer, and he fed me, and gave me a hat and a clean shirt. I told him I was suspected of being a runaway, but was not. I did not like to tell him the truth, being afraid of getting him into trouble. In the afternoon I went to meeting again, staying till it broke up. I had learnt, of the friend who received me in the morning, the name of the minister of the chapel. It was Cole, and I did think of going to him, but gave up the idea, lest I might expose him to danger for helping me. All this I thought of whilst in chapel, and at last made up my mind to leave the town as soon as it got dark. When I set off, however, I found the watch about, and
<pb id="p141" n="141"/>
became alarmed, as I knew they would capture me without ceremony. I therefore slunk back to the house of the man I have referred to, and, quite unknown to him, concealed myself all night in the out-house. Here I put on the clean shirt. I had a bundle with me, containing an old waistcoat, an old Kentucky coat, which I had procured at New Orleans, an old pair of trowsers, and an old shirt. I dressed myself in these things and put up my old ones in the bundle, intending to throw them away.</p>
        <p>In the morning I went down to the water-side, and, on my way, disposed of my bundle on the top of a pile of steam-boat shafts and boilers. When I got to the quay I asked for work, saying I was a carpenter. I might have hired myself over and over again, but I really did not want to do so. I only wanted to avoid suspicion, and get safe into the woods again, so I asked such a high price for my labour that nobody would hire me. I soon found, however, that my conduct in this respect excited suspicion, therefore I at last accepted of a job, undertaking to come the next morning and bring my weekly pass; for I had, in reply to the questions put to me, given out that I was not free, but was allowed by my master to hire myself
<pb id="p142" n="142"/>
out: a thing that is often done. In this way I avoided many embarrassing questions, and got the opportunity of acquiring some very useful scraps of information; to do which, indeed, was one of my principal objects in coming down to the quay.</p>
        <p>After striking my bargain, and sauntering about awhile, I started off till I came to the woods, a mile and a half from the town, where I remained the rest of the day. As soon as it got dark, I took the same road back, intending to return into the town; but I became alarmed, and coming to a steam-mill between two ferries, I crept along on my hands and knees to a place where I had noticed, in the morning, a little boat fastened to a tree, and which it was now my object to get. It lay between the two ferries, and nearly opposite to the upper point of an island that lies between St. Louis and the Illinois bank. I reached the boat, jumped into it, snapped the chain by a rude jerk, and put off. The current was rapid and very strong, and the river of considerable width, and full of snags. My object was to make the upper point of the island, for if I failed, and struck it at any other part, I knew that the current would draw me down to the steam-boat wharf
<pb id="p143" n="143"/>
again, where I should be discovered by the watch. It was with the utmost difficulty I avoided the snags, but at length I touched the island, at the spot I have mentioned. On reaching the bank I encountered another difficulty. The current had undermined the turf, and made it so rotten, that I could not land, not being able to make the boat fast. I was so exhausted, too, by the efforts I had made to reach the Illinois side, that before I recovered myself, I drifted quite three quarters of a mile down, to a place where the stump of a tree stuck up, at the water's edge. Here I succeeded in securing the boat, and when the current brought her gunwale on, close enough to the bank, I leaped ashore.</p>
        <p>By this time it was daylight, and therefore dangerous for me to be seen; but I had no alternative save to walk on till I should reach a convenient place of concealment. I had not proceeded very far, before I saw a white man, to whom I made up.</p>
        <p>“If you please, Sir,” said I, “do you know of a coloured man living away about here?”</p>
        <p>“What name?” asked he.</p>
        <p>“Well, Sir,” I answered, “I can't remember his name. I've forgotten it. But I was told he used to live about here.”</p>
        <pb id="p144" n="144"/>
        <p>“Name Cæsar?” asked the stranger.</p>
        <p>“That's it, I think,” said I.</p>
        <p>“Well, yes, there's a coloured man of that name does live on this side. He's down away yonder, a good bit, cutting walnut cord-wood. If you go on, you're sure to meet with him.”</p>
        <p>With my heart leaping almost into my throat, I thanked the man, and went on, and some time after came to the place where Cæsar was very busy plying his axe. We were not long in coming to an understanding. I told him my story; he gave me shelter in his shanty, shared his food with me, and I sat with him till dark. I learnt from him that he was the only coloured man who lived on that side, close to the river, for there was no business doing there; so although the question I had put to the white man was quite a natural one, under the circumstances in which I was placed, I had every reason to congratulate myself on having been so fortunate as to fall in with Cæsar at this particular time.</p>
        <p>This good fellow gave me the most precise information about the country, advising me what roads to take, and what towns to avoid. He advised me not to make for Chicago; to avoid Springfield, and to go to Indianapolis by way of Vandalia. He also directed me to call at a place,
<pb id="p145" n="145"/>
the name of which, I think, is Rockville, where I should find a coloured man, a friend of his, from North Carolina, on whose aid I might rely. Accordingly I set off again at night, walking until day-break, through a small prairie, extending between the Mississippi and the forks of the Springfield and Vandalia roads. By the time it was light, however, I had not got further than about seven miles from the river, the road through the prairie being cut up into deep ruts by waggons and carts, and all filled with mud and water. As it was not safe for me to continue my journey, I looked about for a place of concealment, and soon found one, in the lock of a high wooden fence, the end of which went down to the water's edge. Here I intended staying till night. I made my walking-stick serve as a seat, by fixing it across the timbers of the fence, and then crouched down, so as to avoid being seen as much as possible; but, overcome by fatigue, I fell asleep.</p>
        <p>I was awakened by a voice, crying out—</p>
        <p>“Hallo, old fellow! Are you asleep?”</p>
        <p>I looked up, and remembering the advice I had received from Cæsar, never to look frightened if I should be surprised by any one, I answered, without getting up:</p>
        <pb id="p146" n="146"/>
        <p>“No, I'm not asleep! I was asleep till you waked me, though.”</p>
        <p>The party who spoke to me was a common-sized man, who had perched himself up on the top of the fence, which was from seven to eight feet high, and made of split timbers, ten feet and a half long. He held a fowling-piece across his lap, and had I started off, could easily have shot me, for I must have run before him, the fence preventing my getting away in one direction, the water in the other, and the prairie in a third.</p>
        <p>“Which way are you going?” he asked.</p>
        <p>“I'm not going anywhere,” I replied. “I'm sitting down.”</p>
        <p>Bethinking myself that I ought to show a reason for being asleep so early in the morning, I scrambled up, and pretended to be drunk, staggering, and reeling, and looking foolishly at him.</p>
        <p>“Hie, old fellow!” he said, then; “you've been drinking, I reckon.”</p>
        <p>“Yes, Sir, been drinking a little,” I answered.</p>
        <p>“Do you live in this part of the country?” he inquired.</p>
        <p>“Oh no! My home is in Buffalo,” I made answer; for Cæsar had told me to say so, if any
<pb id="p147" n="147"/>
one asked me such a question. “I've been following the water, and I got away round to New Orleans, and from there to St. Louis. Now I'm going on through the country, on by Vandalia, to see my cousin.”</p>
        <p>“Well, old fellow,” the man said; “you had better hire yourself out to me. Don't you want to cut some cord wood?”</p>
        <p>“What sort of pay will you give me?” said I.</p>
        <p>“Half a dollar a-day,” he answered.</p>
        <p>“What will you pay me in?” I asked.</p>
        <p>“Well, wouldn't you like to have a gun?”</p>
        <p>“What sort of a gun?”</p>
        <p>“This one,” he said, patting the one he held.</p>
        <p>“That gun's of no account,” I said; and here I staggered again.</p>
        <p>“It's very good to shoot ducks with,” he made answer.</p>
        <p>“Oh,” I said; “the land's so wet that you can't travel by it, let alone going into the water after ducks. But I think I'll take your offer, for the weather is so bad, I don't suppose I shall be able to get along very well.”</p>
        <p>“Well,” he answered, “you go up to the house yonder, and I'll go to Vandalia road to get some eggs.”</p>
        <pb id="p148" n="148"/>
        <p>So saying, he jumped down from the fence and went on.</p>
        <p>The house was half a mile from this place. I made straight for it, but the mistress of the house, who was in the horse-yard, would not let me in when I knocked at the door. I suppose she was afraid, for I know she saw me as I was going by. I turned from the door, and observing that the men in the field had stopped their horses, and were leaning against the handles of their ploughs, watching me, I thought it best to go up boldly to them, so as to avert suspicion. I pretended to want work, and in answer to their questions, told them I was a carpenter and joiner. They said they did not want any mechanical workman, but that if I went on the Springfield road, down under the Bluff, there was a man there would employ me. As I saw woods in the direction they pointed out, their advice suited me very well; so I went on till I got into the woods on the Springfield road. Here I found a chunk of a blown-down tree. I got behind it, and as it was crooked, I could, by lying down, very conveniently peep out from under the crook. I watched to see whether any persons were following me, or dogging my steps, but saw no
<pb id="p149" n="149"/>
one; so I remained till dark, when I set off again.</p>
        <p>I had been wringing wet now for forty-eight hours, and when I got up, was all of a shiver; but I went on, notwithstanding, till morning came, by which time I was in the high road to Vandalia, having crossed the woods in the night. At last I reached the place to which Cæsar had directed me. Here I soon made out the man I wanted. I got a rest at his dwelling, and induced him to get me a free pass, for which I made him take an old watch. With that pass I assumed the name of John Brown, which I have retained ever since.</p>
      </div1>
      <div1 type="chapter">
        <pb id="p150" n="150"/>
        <head>CHAPTER XVI. <lb/> I AM ADVERTISED AS A RUN-AWAY.</head>
        <p>HAVING now assumed such a name as I could safely travel by, I set off for Vandalia, which took me a week to reach, walking by night, and lying by in concealment in the day, to recruit myself by such sleep and rest as I could snatch. I ran very short of food the whole time, and experienced many serious difficulties from my ignorance of the roads, and my fears of being captured. I found the rivers a serious obstacle, too, for I did not always light upon canoes, ferries, or the proper fording-places. I incurred great risk besides, in seeking information respecting the best roads to distant places. My plan, however, was to lurk about in the neighbourhood of some isolated dwelling, until it was quite late in the night, and people were fast asleep. I would then knock them up out of their beds, when they would hasten to the window, and look out, half awake, to see what was the matter. I would then put the questions I wanted answered, and as they
<pb id="p151" n="151"/>
could not see my colour in the dark, I never found them backward in replying, as they seemed always in too great a hurry to get back to bed. In this manner, and though I was in constant fear, I contrived to steer pretty clear of danger, keeping by the high-road from Vandalia, until I reached Terrehaute, on the Wabash river.</p>
        <p>I crossed this river in a canoe which I found moored to the bank. It was in the night, and I had to walk about until morning, keeping a sharp look-out all round. I watched until I saw a coloured man, whom I addressed, and to whom I told my story. In the course of conversation we found out that the preacher at St. Louis was his brother. He was quite glad to hear of him through me, and took me home, where he gave me some refreshment. But I could not remain with him, he said, as it would expose him to danger, so he directed me to a settlement of coloured people, situated at about three miles from his place, where he intimated I could remain a while in safety. I reached it without difficulty, and passing myself off as a free man, staid in the place for two weeks, doing jobs of carpentering, at the end of which time I found it desirable to start off again on my travels, in consequence of
<pb id="p152" n="152"/>
the people's suspicions becoming excited by my answers to their questions. So I set off for Indianapolis, the road to which I had ascertained.</p>
        <p>Here I got a great fright. I chanced to fall in with a coloured man who was out white-washing. On my accosting him he looked at me very hard, and presently informed me I was in great and immediate danger, for that there were advertisements out, giving an accurate description of my person, and offering a very large sum for my apprehension. This was, indeed, sad news for me, though I might have expected it. Jepsey James had issued the notices, and sent them flying all through the country by means of the steamers and other modes of transmitting information. My friend—and a true friend he proved to me; may God bless him!—told me it would be more than his life was worth if we were seen together; but for all that, he took me to his house, and concealed me till night. On our way he pointed out the placards on the walls, and read what they said; and sure enough my master had drawn my picture so well, that nobody could have mistaken me, unless he had been blind. When we reached his house, he gave me plenty to eat—not before I
<pb id="p153" n="153"/>
wanted it—and what I required then still more, good advice, of which he was not sparing. He told me that so many slaves were escaping from slavery, that the slave-holders were all roused, and determined to deal a terrible revenge on the first one they caught running off. Those in the more Southern states had sent forward to their friends north, who were all on the look-out to help them in defence of their common interests. A great many runaways had been traced to that neighbourhood, which was all in a commotion in consequence. He added that the Quakers were known to have helped off the runaways, by the Underground Railroad, and that they had been brought into great trouble through it, and through having otherwise protected the coloured people. Numbers of them, he said, had been ruined by law-suits, which the slave-holders had brought against them; others had had their farm-houses burnt down, their woods and plantations set on fire, their crops destroyed, their stock driven off; and many of them had been themselves seriously injured by the violence of mobs. Still, they kept on helping off as many slaves as ever, because they felt it to be their duty to do so, and nothing would turn them from it.</p>
        <pb id="p154" n="154"/>
        <p>I felt very much distressed to hear of these things; and though I had never seen any of the people he spoke about, my gratitude to them was unbounded, for I felt that if I could once get into their hands, I should be safe. I have since learnt to love them, for what they did for me then, and for what they have done for me since. The memory of their kind deeds will ever live in my heart while it beats.</p>
        <p>My friend gave me a full account of the Underground Railroad, for as I did not understand any thing about it, I asked him a good many questions. I have been permitted to add, in another chapter, a brief history of it, penned by the Editor of my Narrative. I have met with, I may say, many hundreds of persons in England, who do not know more about the Underground Railroad than I did once; and to those who are in similar ignorance, that chapter will be as interesting as any that relates to myself.</p>
        <p>My good friend also informed me in what direction I should go that night, in order to reach a certain town on Blue River, within, say a hundred miles of Carthage, and where one of the managers of the line resided. He gave me his name, and precise instructions to find out his residence;
<pb id="p155" n="155"/>
but, for obvious reasons, I do not think it prudent to mention his name, or that of the town in which he lived; nay, perhaps lives now. His was the first station of the Underground line, in that part of the country, and it was absolutely necessary for me to reach it that night. It was thirty miles from my friend's house, and he impressed upon me the necessity of making up my mind to accomplish the distance before day-break, or I should certainly be lost; that is, captured. Of course, with such a prospect before me, I had every inducement to task my remaining strength to the utmost, in order to cover the ground within the time, though, it being now the month of August, the space between night-fall and day-break was not any too long for me to do what was before me. As soon, however, as it set in quite dusk to make it safe for me to go, I took leave of my benefactor, and set out with a stout heart.</p>
        <p>What I endured of anxiety that night will never be effaced from my memory. I had received general instructions for my guidance on the road, and been told what villages I should have to go through. But in order to avoid incurring unnecessary risk, when I reached a village, instead of passing through it, I would make a turn and go round it,
<pb id="p156" n="156"/>
endeavouring to strike the road a little beyond. This did not always succeed. More than once, after going right round one side of a village, and coming to a road, my heart misgave me, and in obedience to a secret presentiment that all was not right, and which I found it impossible to resist, I turned back, and beat about until I struck another road, even retracing my steps, more than once, until I came to the road that left no misgiving on my mind, when I would go on again as brave as a lion.</p>
        <p>Many people will say I was superstitious. And so I was. But the feeling was a kind of instinct, whose cautions, even at the present day, I cannot help minding.</p>
        <p>In this way I walked and ran the whole night, but as day broke I had the satisfaction of seeing afar off, the town I was making for, and very soon after, I enjoyed the still greater pleasure of finding myself in a place of safety.</p>
      </div1>
      <div1 type="chapter">
        <pb id="p157" n="157"/>
        <head>CHAPTER XVII. <lb/> I AM BOOKED TO CANADA, EXPRESS, BY THE <lb/> UNDERGROUND RAILROAD.</head>
        <p>I HAD been instructed by my friend to seek out a certain coloured man, on my arrival at the town in which I now was, and where there was a considerable settlement of Quakers. He had given me a very precise description of the spot where his house stood, and by what signs I should know it. Accordingly I lost no time in seeking it, and soon found it out. My new friend was at home, and on my making myself known to him, which I did by mentioning the name of our mutual acquaintance, he knew what I wanted. He then gave me directions to go to a certain house, which he pointed out to me, where I should be in safety. He could not accompany me, as that would have been imprudent, and have exposed him to danger. I made straight for the place, and, on being seen, was instantly taken in.</p>
        <p>Between nine and ten months had now elapsed since I left De Cator Stevens', the whole of which
<pb id="p158" n="158"/>
time had been one of sore trial to me. Having, however, brought my readers with me to a place of rest, I wish to dwell a little on this part of my history, for what happened to me here, forms an era in my life.</p>
        <p>I was introduced by two sturdy young men to their father, as “another of the travellers bound to the North Star.” The old man laid a hand upon my shoulder, and taking my other hand in his, gave me a welcome, and then conducting me into the parlour, introduced me to his wife. It was now past sun-rise, and they were about going to breakfast. I was, however, taken to an upper room, where I had a good wash, in a white basin, and where clean linen and a complete suit of clothes were brought to me. After refreshing myself by this wholesome change, I was re-conducted to the parlour, and seated at the table.</p>
        <p>It was the first time in my life I had found myself in such grand company. I was so completely abashed, and felt so out of my element, that I had no eyes, no ears, no understanding. I was quite bewildered. As to eating, it was out of the question.</p>
        <p>“Come, friend John Brown, thee must eat,” said the kind old lady, heaping my plate up with
<pb id="p159" n="159"/>
fried ham and eggs. “Thee need'nt be afraid of eating.”</p>
        <p>“I'm sure thee must be hungry,” added the old gentleman, handing me a great chunk of bread. “Eat away, and don't thee be afraid. We have plenty more in the house.”</p>
        <p>But it was all of no use, and though an hour or even half an hour before, I had felt that I could devour any thing, the smoking coffee, ham, eggs, and sausages, and the nice white bread could not tempt me. For a good half hour this continued: they pressing me to eat, and I quite unable to do so. At last I began, and picked a bit now and then, receiving encouragement as my courage seemed to increase. My appetite came with my courage, and then—oh! how I did eat!</p>
        <p>I fear my readers may think I exaggerate when I tell them that “I ate straight on for an entire hour, quite steady.” I demolished all the ham and eggs and sausages they placed before me, with their due accompaniment of bread, and then a round of cold salt beef was brought up,  from which I was helped abundantly. I could not but notice the looks of my new friends. The old gentleman would cough and wipe his eyes now and then,
<pb id="p160" n="160"/>
and the younger folks keep exchanging glances with one another. The old lady, fearing I should do myself an injury, made several ineffectual attempts to draw my attention off.</p>
        <p>“Friend John Brown, we wish to talk with thee, as soon as thou can,” she said; “we want to hear all about thee.”</p>
        <p>“Yes, ma'am,” I answered, without leaving off: “you can go on, ma'am; I can talk and eat too.”</p>
        <p>I dare not say how long I might have gone on. I had not eaten a meal for so long, that now it seemed as though I never could satisfy my craving. At last the old lady said, decidedly:</p>
        <p>“Friend, John Brown, thee must n't take it unkindly, but thee must n't eat any more now. Thou can'st have some more in the day-time if thou like; but thou wilt make thyself ill, if thou take more now.”</p>
        <p>And so I was obliged to give in.</p>
        <p>A chapter from the Scriptures was read after breakfast, which, including my “spell” at the table, had lasted two hours from the time we sat down.</p>
        <p>I was then conducted into a safe retreat, where there was a comfortable bed provided for me,
<pb id="p161" n="161"/>
into which I got, and soon fell asleep. I slept until I was awakened at three in the afternoon, when I was taken down to dinner. After that we sat and chatted until supper-time, and then I went to bed again. In the middle of the night I awoke, and finding myself in a strange place, became alarmed. It was a clear, starlight night, and I could see the walls of my room, and the curtains all of a dazzling whiteness around me. I felt so singularly happy, however, notwithstanding the fear I was in, at not being able to make out where I was, that I could only conclude I was in a dream, or a vision, and for some minutes I could not rid my mind of this idea. At last I became alive to the truth; that I was in a friend's house, and that I really was free and safe.</p>
        <p>I had never learnt to pray; but if what passed in my heart that night was not prayer, I am sure I shall never pray as long as I live.</p>
        <p>I cannot describe the blessed happiness I enjoyed in my benefactor's family, during the time I remained there, which was from the Friday morning to the Saturday night week. So happy I never can be again, because I do not think the circumstances in which I may be placed, will ever be of a nature to excite similar feelings in my breast.</p>
        <pb id="p162" n="162"/>
        <p>At length the time came for me to go, though I was not previously told it was necessary for my own safety that I should quit my benefactors. On the Saturday afternoon week, there had been some talk of the camp of the coloured people, near, where they met for worship, and I was asked, quite cursorily, whether I would like to go and see it. I answered in the affirmative. When it was quite dark—perhaps it might be eight o'clock—I was called out to the door, as if to go and see the camp. There I saw three saddle-horses, on one of which one of the old gentleman's sons was mounted, holding the second horse by the bridle. The other son held the third horse, and was dismounted.</p>
        <p>“Friend John,” he said, “it is not safe for thee to stay any longer; nor for us to keep thee. Come, jump up.”</p>
        <p>There was no alternative but for me to get across the beast that had been provided for me. I did so, not without suspicion that I was going to be taken back into slavery. I hope I may be forgiven for entertaining such a thought; but after all I had passed through, I was not ready to place implicit confidence even in those who treated me as a friend. I am sure I am now very
<pb id="p163" n="163"/>
sorry for ever having suspected my noble saviours.</p>
        <p>They placed me between them, and off we set as hard as our animals could go. We frightened a lot of coloured people in a village we passed through, who were coming from their Saturday night's meeting; and not a few persons opened their doors to come and stare at us, we made such a clatter. At about twelve we reached our destination; the first station of the Underground line from head-quarters.</p>
        <p>I remember very well the odd reception we met with, at the hands of the bluff old Quaker who received us:</p>
        <p>“What! Only one, and coming at this time of night. Why I've room and food ready for a dozen. But come in, come in and rest.”</p>
        <p>My conductors remained talking till half-past one, when they took leave of us. After they were gone, I sat up till three, telling the family of my escape and adventures, and then I retired to bed. The next day, being Sunday, the family went to Meeting. They brought in to dinner a middle-aged, strong-built Friend, who talked with me a good deal. At about three in the afternoon, I was told that horses were ready, and that I must start
<pb id="p164" n="164"/>
with this gentleman, as we had a good way to go. It came very suddenly upon me, to leave so soon, but I complied, of course, and we set off.</p>
        <p>All that afternoon, the whole night, and the whole of the next day, we travelled, only stopping at times to let our beasts graze. I suppose we went a hundred miles, crossing the Wabash again, and going through the Indian reserve on our way. At last, at about three on the Monday afternoon, we reached the station; and glad enough I was.</p>
        <p>My Quaker friend of the pleasant countenance and sturdy frame, remained till next afternoon, when he started back. Finding I was safe, for the present, I thought I would stay here a while. Accordingly I set to splitting rails, with my host's son, and shooting squirrels. But the suspicion of the folks around became excited, so that after I had been here a fortnight, I found it safer to start again. I was encouraged to do so by my host; and having been provided with an ample supply of corn-bread, and meat, I set off to another place, which my friends indicated, about a hundred miles off. I was three or four days getting to it, but was received kindly; and here I should have remained awhile, but was
<pb id="p165" n="165"/>
informed it would be unsafe; so after resting four days, during which time I worked splitting rails, I set off one morning for Marshall, in Michigan.</p>
        <p>It would not interest my readers much to follow me on my journey, for nothing of any consequence occurred to me. I travelled chiefly by night, that being the safest time. Indeed, I made very light of any real privations I now experienced. The sense of present security, and the certainty of freedom awaiting me, more than compensated me for temporary inconveniences. I felt quite happy, knowing I should meet with none but friends on my road to Canada. My way seemed perfectly clear, and the only description I can give of my sensations, is, that I felt like a new man.</p>
        <p>I arrived in Marshall one morning, and was in search of a certain friend, when I was hailed, as I was going down the street, by a number of coloured people who were building a chapel, and who had been hired to do the work by Mr. Fitch. They asked me various questions, and I soon discovered that, like myself, they were fugitives from slavery. Their names were Samuel Patterson, Noel Johnson, Thomas Smith, a man named Samuel, Elias Earle, and Thomas
<pb id="p166" n="166"/>
Christopher. They told me I need not fear any thing, as I was now quite out of danger, and asked me whether I would join them, and work for my living. I readily consented, and accordingly I was set to carry bricks and mortar. On the third day I felt unaccountably dull, and something told me not to go to my work, so, instead, I went into the woods to cut timber for the same building, which occupation suited me better, I being a carpenter. I had been there about half the day, when some one came and told me that the props of the chapel had given way, and that the men had only escaped by a sort of miracle.</p>
        <p>Another curious circumstance also happened whilst I was employed here. Two of my mates, Noel Johnson and Thomas Smith, had belonged to one John Shelby, of Lexington, in Kentucky. They had been willed to his son-in-law, one West, and he had removed them into Missouri, whence they had run off. West traced them to Marshall (where I fell in with them,) after they had been there quite two years, and one day made his appearance for the purpose of claiming and taking them back into slavery. When we heard of it, we determined to stand by them; and all rose, as one man, to defend them, and prevent
<pb id="p167" n="167"/>
them from being carried off. Finding us so resolute, West became very much alarmed, and actually appealed to his former slave, Johnson, for protection. Johnson at once extended it to him; took him home and gave him some dinner, and afterwards got him safely away.</p>
        <p>But to return to myself. I remained in Marshall until the chapel was completed—that is, for about a twelvemonth—and then made straight for Detroit. Here I fell in with one Mr. Joseph Teague, captain of a party of Cornish miners, who were fitting out to explore the copper region on Lake Superior. I engaged myself to Captain Teague, believing that I should be safer with Englishmen in the mines than anywhere else. He was a native of Redruth, in Cornwall, where he resided when at home. He had come over under contract, to test the copper-mines belonging to Jones &amp; Co., of Boston. We went from Detroit to Copper Harbour, by Mackinaw and Sault St. Mary, and thence to the mouth of the Ontonagon River, Michigan. From this place we went to Cyrus Mindenhall's location, and afterwards to the Porcupine Mountains. I remained working in the mines, as a miner's carpenter, for eighteen months, when Captain Teague started to return
<pb id="p168" n="168"/>
to England. I engaged to follow him almost immediately, and to join him in Redruth; but having heard a great deal, since I had been in this part of the country, of the Dawn Institute, at Dawn, Canada West, I wished first to see something of it. Accordingly I made my way to it, and remained five or six months, working at the saw-mill. I helped to saw the walnut timber which was sent to the Great Exhibition in Hyde Park, in 1851, and exhibited in the Canadian department, where I afterwards saw it again; and I also constructed a floating self-acting car-way, designed to draw timber from the water to the saw, which answered very well, and for which I was praised.</p>
        <p>I had not reason to be pleased with the manner in which the affairs of the Dawn Institute were managed. I will not mention names, because I do not want to speak disparagingly of any body. But, in consequence, I left Dawn, sooner than I intended, and having a little money to receive for work that I had done, I secured a berth on board the <hi rend="italics">Parliament,</hi> Captain Brown, bound from Boston to Liverpool. We left the former port the last week in July 1850, and reached Liverpool on the 10th of August, after a surprising run of fifteen days.</p>
        <pb id="p169" n="169"/>
        <p>Thus, after all my trials and sufferings, I found myself at last safely landed in the town where poor John Glasgow left his wife and children so many years before.</p>
        <p>I lost no time in making my way to Redruth, as I was anxious to begin work under my old captain and friend, Joe Teague. To my great grief, when I reached the town, I learned that he had never returned to England, but had died in Boston. I saw his son William, however, and a friend of the captain's, one Mr. Richardson, and also the clergyman of the parish, from all of whom I obtained testimonials. There are now miners working in the mines there, with whom I worked in those of Lake Superior. Their names are Thomas Champion, Thomas Williams, James Vivian, Richard George, William George, Thomas Polkinghorn, and Richard Pascoe, who, with Captain Teague and his son Joseph, were in my mine, and worked by my side.</p>
        <p>I said two months at Redruth, earning enough to maintain me by reciting my adventures in meetings got up for me by my Cornish friends. I then went to Bristol, where I procured employment at a carpenter's shop. I remained here four weeks, but though I worked hard, I did not see my way
<pb id="p170" n="170"/>
to rising, as a man, so I went to Heywood, in Lancashire, and engaged myself to Mr. John Mills, a builder. I worked here until I found that there is prejudice against colour in England, in some classes, as well as more generally in America; and as I had an object to accomplish—of which I shall speak presently—I thought I had better make my way to London, and set about seeking the means of carrying that object out. With this view I quitted my employment, after a proper understanding with Mr. Mills, with whom I was on the best of terms, and reached the metropolis, one Wednesday evening, some time in April 1851.</p>
      </div1>
      <div1 type="chapter">
        <pb id="p171" n="171"/>
        <head>CHAPTER XVIII. <lb/> THE CULTIVATION OF COTTON, TOBACCO, AND <lb/> RICE.</head>
        <p>BEFORE I address myself to set forth what is now the grand object of my life; the object to which I wish to devote the rest of my days, and the best of my energies; and before I venture to present my own reflections on Slavery, and my views as to what should be done to put it down, it may be useful that I should present my readers with a brief account of the mode of cultivating Cotton, and Tobacco, and Rice, as practised in the plantations on which I have myself worked, or have had opportunities of visiting.</p>
        <p>COTTON being the staple production of the Southern States, much attention is paid to its cultivation. When the price rises in the English market, even but half a farthing a pound, the poor slaves immediately feel the effects, for they are harder driven, and the whip is kept more constantly going. I often think that if the ladies in this country could see the slave women, and
<pb id="p172" n="172"/>

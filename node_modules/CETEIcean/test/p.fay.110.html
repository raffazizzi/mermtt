    ...
    <script type="text/javascript">
      ...
      c.addBehaviors({
        "tei": {
          ...
          "orig": [
            ["div.apparatus tei-orig", function(e) {
              this.hideContent(e);
            }]
          ],
          "rdg": [
            ["div.apparatus tei-rdg", ["", " prev. ed."]],
            ["tei-tei tei-app>tei-rdg", function(e) {
              this.hideContent(e);
            }]
          ],
          "reg": [
            ["div.apparatus tei-choice>tei-reg", ["l. ","."]],
            ["tei-tei tei-choice>tei-reg", function(e) {
              this.hideContent(e);
            }]
          ],
          "supplied": [
      ...
      c.getHTML5('p.fay.110.xml', function(data) {
        ...
        // Clean up adjacent ][
        var tmp = document.evaluate("//tei-text//span[not(@data-original)]/text()",document,null,XPathResult.ORDERED_NODE_ITERATOR_TYPE,null);
        var spans = [];
        var n;
